...
def replicas = "1"
def devProject = javibc1-dev // TODO: Your dev project name goes here
def testProject = javibc1-test // TODO: Your test project name goes here
def prodProject = javibc1-prod// TODO: Your prod project name goes here
